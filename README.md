...
自包含的离线语音用例编写与执行 skill。用于把需求文档、词表 Excel、tone.h 与待测固件整合成同一套可迁移 bundle，在本目录或准备出的 workspace 内完成 spec/cases/deviceInfo 生成、dry-run、烧录、runner 执行与结果归档。用户明确提到 `marsMoon`、`$mars-moon`、用例编写、用例执行、需求文档、词表、tone、串口测试、`COM8`、`COM10`、`COM13`、`COM14`、`COM15`、语音 runner 等关键词时应触发。
...
- `tools/__init__.py`
- `tools/audio_device_config.py`
- `tools/audio_devices.json`
- `tools/audio_playback.py`
- `tools/burn_bundle/app.bin`
- `tools/burn_bundle/linux/Uart_Burn_Tool`
- `tools/burn_bundle/linux/app.bin`
- `tools/burn_bundle/linux/burn.sh`
- `tools/burn_bundle/linux/run_burn.sh`
- `tools/burn_bundle/linux/runall.sh`
- `tools/burn_bundle/windows/Uart_Burn_Tool.exe`
- `tools/burn_bundle/windows/burn.ps1`
- `tools/burn_bundle/windows/run_burn.bat`
- `tools/burn_bundle/windows/runall.bat`
- `tools/codex_skill_bootstrap.py`
- `tools/dooya_case_builder.py`
- `tools/dooya_deviceinfo_builder.py`
- `tools/dooya_link_probe.py`
- `tools/dooya_spec_builder.py`
- `tools/dooya_voice_runner.py`
- `tools/serial_port_config.py`
...
- `wavSource/纱帘模式.mp3`
- `wavSource/设置唤醒词.mp3`
- `wavSource/设置工作模式.mp3`
- `wavSource/设置窗帘模式.mp3`
- `wavSource/语音模式.mp3`
- `wavSource/配对遥控器.mp3`
- `wavSource/阳台窗帘.mp3`
- `wavSource/餐厅窗帘.mp3`
